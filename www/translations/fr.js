...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
    'Faire prendre successivement à la variable « %1 » les valeurs entre le nombre du début et celui de fin en incrémentant du pas spécifié et exécuter les instructions spécifiées.';
...
Blockly.Msg.PROCEDURES_CALL_DISABLED_DEF_WARNING =
    'Impossible d\'exécuter la fonction définie par l\'utilisateur \'%1\' car le bloc de définition est désactivé.';
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_A_PARAMETER =
    'Une variable nommée « %1 » existe déjà comme paramètre dans la procédure « %2 ».';
