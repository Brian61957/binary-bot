...
Blockly.Msg.PROCEDURES_CALL_DISABLED_DEF_WARNING =
    'Невозможно запустить пользовательскую функцию \'%1\', поскольку блок определения отключен.';
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_A_PARAMETER =
    'Переменная с именем \'%1\' уже существует в качестве параметра в процедуре \'%2\'.';
